...
$nama_aplikasi = (isset($_POST['nama_aplikasi'])) ? trim($_POST['nama_aplikasi']) : '';
...
if(isset($_POST['submit'])):	
	...
	if(empty($errors)):
		...
		$handle = $pdo->prepare('INSERT INTO alternatif (nama_aplikasi, pengembang, tanggal_input) VALUES (:nama_aplikasi, :pengembang, :tanggal_input)');
		$handle->execute( array(
			'nama_aplikasi' => $nama_aplikasi,
			'pengembang' => $pengembang,
			'tanggal_input' => date('Y-m-d')
		) );
		$sukses = "Nama alternatif <strong>{$nama_aplikasi}</strong> berhasil dimasukkan.";
				...
				<div class="card-body">
					<form action="tambah-alternatif.php" method="post">
						...
						<div class="form-group">					
							...
							<input type="text" class="form-control" name="nama_aplikasi" value="<?php echo $nama_aplikasi; ?>">
						</div>					
						<div class="form-group">					
							<label>Pengembang Aplikasi<span class="text-danger">*</span></label>
							<input type="text" class="form-control" name="pengembang" value="<?php echo $nama_aplikasi; ?>">
						</div>			
