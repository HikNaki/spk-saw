        ...
        <div class="col">
                ...
                switch($status):
                    ...
                    case 'sukses-hapus':
                        ...
                        break;
                    case 'sukses-edit':
                        $msg = 'Alternatif berhasil diedit';
                        break;
                endswitch;
            ...
            <div class="card mb-5">
                <div class="card-header">
                    ...
                    $query->execute();
                    // menampilkan berupa nama_aplikasi field
                            ...
                            <tbody>
                                <?php while($hasil = $query->fetch()): ?>
                                    <tr>
                                        ...
                                        <td><?php echo $hasil['nama_aplikasi']; ?></td>							
                                        <td><?php echo $hasil['pengembang']; ?></td>	
                                        ...
                                        <a href="edit-alternatif.php?id=<?php echo $hasil['id_alternatif']; ?>"><i class="fa fa-edit" data-toggle="tooltip" title="Edit"></i> </a>
