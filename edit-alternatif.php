...
if(!$id_alternatif) {
	...
	$nama = (isset($result['nama_aplikasi'])) ? trim($result['nama_aplikasi']) : '';
	$pengembang = (isset($result['pengembang'])) ? trim($result['pengembang']) : '';
	$tanggal_input = (isset($result['tanggal_input'])) ? trim($result['tanggal_input']) : '';
}

if(isset($_POST['submit'])):	
	
	$nama = (isset($_POST['nama_aplikasi'])) ? trim($_POST['nama_aplikasi']) : '';
	$pengembang = (isset($_POST['pengembang'])) ? trim($_POST['pengembang']) : '';
	...
	if(empty($errors)):
		...
		$prepare_query = 'UPDATE alternatif SET nama_aplikasi = :nama_aplikasi, pengembang = :pengembang, tanggal_input = :tanggal_input WHERE id_alternatif = :id_alternatif';
		$data = array(
			'nama_aplikasi' => $nama,
                            ...
                            <div class="card-body">
                                <form action="edit-alternatif.php?id=<?php echo $id_alternatif; ?>" method="post">
                                    ...
                                    <div class="form-group">					
                                        ...
                                        <input type="text" class="form-control" name="nama_aplikasi" value="<?php echo $nama; ?>">
                                    </div>					
                                    <div class="form-group">					
                                        <label>Pengembang Aplikasi</label>
                                        <textarea class="form-control" name="pengembang" cols="30" rows="2"><?php echo $pengembang; ?></textarea>
                                    </div>
                                    <div class="form-group">					
